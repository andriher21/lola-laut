		...
		<nav class="navbar navbar-expand-lg bg-light fixed-top">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					...
					<a class="btn btn-light" href="customer" role="button">Customer</a>
				</div>
			</div>
		</nav>
			...
			<div class="row align-items-start">
				...
				<div class="col">
					<div class="card border-success" ng-if="tab==1">
						<h5 class="card-header">Customer ID: NEW</h5>
						<div class="card-body">
							<div class="row">
								<div class="col"></div>
								<div class="col-6">
									<div class="mb-3 row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="customername" ng-model="row.customername">
										</div>
									</div>
									<div class="mb-3 row">
										<label for="customeraddr" class="col-sm-2 col-form-label">Address</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="customeraddr" ng-model="row.customeraddr">
										</div>
									</div>	
									<div class="mb-3 row">
					...
					<div class="card border-warning" ng-if="tab==2">
						<h5 class="card-header">Customer ID: {{row.customerid}}</h5>
						<div class="card-body">
							<div class="row">
								<div class="col"></div>
								<div class="col-6">
									...
									<div class="mb-3 row">
										<div class="col-sm-2"></div>
										<div class="col-sm-10">
											<button type="submit" class="btn btn-warning" ng-click="updaterow(row.customerid)">Update</button>
											<button type="submit" class="btn btn-danger" ng-click="deleterow(row.customerid)">Delete</button>
					...
					<div class="card border-primary">
						<h5 class="card-header">Customer Index</h5>
						<div class="card-body">
							...
							<table class="table">
								...
								<tbody>
									<tr ng-repeat="x in table">
										...
										<td>{{ x.companynpwp }}</td>
										<td>
											<button type="button" class="btn btn-outline-primary btn-sm" ng-click="loadrow(x.companyid)">Info</button>
										</td>
									</tr>
								</tbody>
							</table>
		...
		<script>
			...
			myApp.controller('myCon', ($scope, $http) => {
				...
				$scope.insertrow = function () {
					var formData = {};
					formData.name = $scope.row.customername;
					formData.addr = $scope.row.customeraddr;
