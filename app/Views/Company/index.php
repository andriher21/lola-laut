...
<div class="container-fluid customer-data">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="input-group mb-3">
                        <input type="text" id="searchbox" class="form-control" placeholder="Search by company name">
                    ...
                    <tbody>
                        ...
                        foreach ($company as $u) : ?>
                            <tr>
                                <td class="pr-4 pl-0">
                                    <div class="custom-control custom-checkbox table-checkbox">
                                        <input type="checkbox" class="chkboxes check check-data" name="checkbox" value="<?= $u['company_id'] ?>" data-name="<?= $u['company_name']; ?>">
                                    </div>
                                </td>
                                <td><?= $u['company_no']; ?></td>
                                <td><?= $u['company_name']; ?></td>
                                <td><?= $u['company_address']; ?></td>
                                <td><?= $u['company_npwp']; ?></td>
                            
                                <td>
                                    <?php if($_SESSION['role_id'] == '1' || $_SESSION['role_id'] == '4'){ ?>
                                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalEdit<?= $u['company_id']; ?>" style="margin:auto; display:block;">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                    <?php }
                                    elseif($_SESSION['role_id'] == '2'){ ?>
                                        <button class="btn btn-sm btn-danger restore-token" id="<?= $u['company_id']; ?>" style="margin:auto; display:block;" title="Restore Data">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Cmpany</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" action="<?= base_url('addcompany') ?>" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                            <div class="col-md-12">
                                    <label for="message-text" class="col-form-label">No <small class="text-danger"><u>*</u></small></label>
                                ...
                                <div class="col-md-12">
                                    <label for="message-text" class="col-form-label">NPWP<small class="text-danger"><u>*</u></small></label>
    ...
    <?php foreach ($company as $u) : ?>
        <div class="modal fade" id="modalEdit<?= $u['company_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <!-- <h5 class="modal-title" id="exampleModalLongTitle">Delete Schedule</h5> -->

                        <h6 class="modal-title font-weight-bold text-primary"> Manage Company</h6>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form method="POST" action="<?= base_url('editcompany') ?>" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $u['company_id'] ?>">
                        <div class="modal-body">
                            <div class="form-group">
                            <div class="row mb-2">

                                    <div class="col">
                                        <label class="col-form-label font-weight-bold text-dark">No</label>
                                        <input type="text" value="<?= $u['company_no'] ?>" class="form-control" name="no">
                                    </div>
                                    </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="<?= $u['company_name'] ?>" class="form-control" name="name">
                                    </div>
                                </div>
                                <div class="row mb-2 ">
                                    <div class="col">
                                        <label class="col-form-label font-weight-bold text-dark">Address</label>
                                        <input type="text" value="<?= $u['company_address'] ?>" class="form-control" name="address">
                                    </div>
                                </div>
                                <div class="row mb-2 ">
                                    <div class="col">
                                        <label class="col-form-label font-weight-bold text-dark">NPWP</label>
                                        <input type="text" value="<?= $u['company_npwp'] ?>" class="form-control" name="npwp">
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Import Company</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
