                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class=" modal-footer">
                            <?php if($u['serverA_id'] != null || $u['serverB_id'] != null ) {?>
                                <div class="col-2">
                                <?php if($u['flag_server'] == '0') {?>
                                    <p class="text-center font-weight-bold">Server A</p>
                                 <?php  }
                                 elseif($u['flag_server'] == '1'){
                                     ?>
                                    <p class="text-center font-weight-bold">Server B</p>
                                    <?php  }?>
                                </div>
                                <div class="col-2">
                                    <button class="btn btn-sm btn-primary button-center" id="<?= $u['transaksi_id']; ?>"  style="margin:auto; display:block;" title="Move Data">
                                        <i class="fas fa-arrow-circle-right"></i>
                                    </button>
                                     
                                </div>
                                <div class="col-2">
                                <?php if($u['flag_server'] == '1') {?>
                                    <p class="text-center font-weight-bold">Server A</p>
                                 <?php  }
                                 elseif($u['flag_server'] == '0'){
                                     ?>
                                    <p class="text-center font-weight-bold">Server B</p>
                                    <?php  }?>
                                </div>
