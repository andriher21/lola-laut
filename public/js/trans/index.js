...
var readCSV = '/readCSVtrans';
var deleteUrl = '/deletetrans';
var importURL = '/doImporttrans';
var sync= '/synctrans';
...
function drawImportTable(data) {
    ...
    $.each(data, function(i, v) {
        ...
        // html += '<td>'+ ++count +' </td>'
        html += '<td id="vehicle">' + v.vehicle + '</td>';
        html += '<td id="owner">' + v.owner + '</td>';
        html += '<td id="company">' + v.company + '</td>';
        html += '<td id="type_vcl">' + v.type_vcl + '</td>';
        html += '<td id="material">' + v.material + '</td>';
        html += '<td id="panjang">' + v.panjang + '</td>';
        html += '<td id="lebar">' + v.lebar + '</td>';
        html += '<td id="tinggi">' + v.tinggi + '</td>';
        html += '<td id="volume">' + v.volume + '</td>';
        // html += '<td id="overweight">' + v.overweight + '</td>';
        html += '</tr>';
    });
    if (html !== '') {
...
function doImport() {
    ...
    $('.check-import:checked').each(function(i, dom) {
        index = $(dom).val();
        // console.log(index);
        vehicle = new_u[index]['vehicle'];
        owner = new_u[index]['owner'];
        company = new_u[index]['company'];
        type_vcl = new_u[index]['type_vcl'];
        material = new_u[index]['material'];
        panjang = new_u[index]['panjang'];
        lebar = new_u[index]['lebar'];
        tinggi  = new_u[index]['tinggi'];
        volume = new_u[index]['volume'];
        // overweight = new_u[index]['overweight'];
