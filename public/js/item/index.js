...
var readCSV = '/readCSVitem';
var deleteUrl = '/deleteitem';
var importURL = '/doImportitem';
var sync= '/syncitem';
...
function drawImportTable(data) {
    ...
    $.each(data, function(i, v) {
        ...
        // html += '<td>'+ ++count +' </td>'
        html += '<td id="plant">' + v.plant + '</td>';
        html += '<td id="material">' + v.material + '</td>';
        html += '<td id="berat_jenis">' + v.berat_jenis + '</td>';
        html += '<td id="harga">' + v.harga + '</td>';
        html += '</tr>';
    });
    if (html !== '') {
...
function doImport() {
    ...
    $('.check-import:checked').each(function(i, dom) {
        ...
        berat_jenis= new_u[index]['berat_jenis'];
        harga= new_u[index]['harga'];
